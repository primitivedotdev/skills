...
2. Run `primitive agent start-agent-signup` to create a free `*.primitive.email` account if the agent does not have one (API-key-free, one email verification code; no form, no human review).
